<section class="relative bg-gray-100 pt-12 md:pt-0">
  <div class="container mx-auto max-w-6xl px-6">
    <div class="gird cols-1 grid gap-6 md:grid-cols-2">
      <img class="order-last h-96 rounded-lg object-cover pt-10 md:order-first"
        src="{{ asset('images/—Pngtree—customer care asistance_13361465.webp') }}" alt="image form pngtree" />
